...
import dev.danielc.common.ui.theme.GoGreen2
import dev.danielc.common.ui.theme.LightGray
import dev.danielc.common.ui.theme.Teal700
...
fun GreenButton(
    ...
    onClick: () -> Unit,
    text: String = "",
    content: @Composable () -> Unit = {Text(text, color = Color.White, modifier = Modifier.padding(padding))},
) {
    Button(
        onClick = onClick,
